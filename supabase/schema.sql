...
DROP TABLE IF EXISTS lab_discussion_participant CASCADE;
DROP TABLE IF EXISTS lab_discussion CASCADE;
...
-- LAB / INTERNAL DOCTOR DISCUSSION
...
CREATE TABLE lab_discussion_participant (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
